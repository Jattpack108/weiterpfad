...
import { imprintSections, legalNotice, pageDescriptions } from "@/data/site-content";
import { buildMetadata } from "@/lib/metadata";

export const metadata: Metadata = buildMetadata("Impressum", pageDescriptions.imprint);
...
export default function ImprintPage() {
  return (
    <>
      <PageHero
        eyebrow="Rechtliches"
        title={legalNotice.imprintTitle}
